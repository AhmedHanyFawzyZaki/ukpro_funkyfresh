    ...
    'items'=>array(
        ...
        array(
         ...
         array('label'=>'Content', 'url'=>'#','items'=>array(
					...
					array('label'=>'Sizes', 'url'=>array('/size')),

			 		), 'itemOptions'=>array('class' => 'main-site-link2'), 'visible'=>User::CheckAdmin() ),

		array('label'=>'Lists', 'url'=>array('#'),'items'=>array(

                   	array('label'=>'Jacket Types', 'url'=>array('/category')),
					array('label'=>'Stripes', 'url'=>array('/stripe')),
					array('label'=>'Stripe Border', 'url'=>array('/stripeBorder')),
					array('label'=>'Font Colors', 'url'=>array('/color')),
					array('label'=>'Snap', 'url'=>array('/snap')),
					

                 	//array('label'=>'Countries', 'url'=>array('/AllCountries')),
		...
		/*array('label'=>'Colors & Jackets', 'url'=>array('#'),'items'=>array(
	   ...
	   array('label'=>'Orders', 'url'=>array('/orders'),'items'=>array(     

		), 'itemOptions'=>array('class' => 'main-site-link9'), 'visible'=>User::CheckAdmin() ),
