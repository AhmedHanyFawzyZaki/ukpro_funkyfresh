...
if ($model->isNewRecord != '1' and $model->image != '') {
    echo "<p>" . Chtml::image(Yii::app()->baseUrl . '/media/stripeborder/' . $model->image, 'image', array('width' => 200)) . "</p>";
}
?>

<?php
echo $form->fileFieldRow($model, 'left_image', array('class' => 'span5', 'maxlength' => 255));

if ($model->isNewRecord != '1' and $model->left_image != '') {
    echo "<p>" . Chtml::image(Yii::app()->baseUrl . '/media/stripeborder/left/' . $model->left_image, 'left_image', array('width' => 200)) . "</p>";
}
?>
<?php
echo $form->fileFieldRow($model, 'right_image', array('class' => 'span5', 'maxlength' => 255));

if ($model->isNewRecord != '1' and $model->right_image != '') {
    echo "<p>" . Chtml::image(Yii::app()->baseUrl . '/media/stripeborder/right/' . $model->right_image, 'right_image', array('width' => 200)) . "</p>";
}
?>
<?php
echo $form->fileFieldRow($model, 'back_image', array('class' => 'span5', 'maxlength' => 255));

if ($model->isNewRecord != '1' and $model->back_image != '') {
    echo "<p>" . Chtml::image(Yii::app()->baseUrl . '/media/stripeborder/back/' . $model->back_image, 'back_image', array('width' => 200)) . "</p>";
}
?>
