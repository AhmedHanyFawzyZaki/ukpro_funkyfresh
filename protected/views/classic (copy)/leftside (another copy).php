                        ...
                        <div class="body-picker">
                            ...
                            foreach ($products as $product) {
                                ...
                                echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'body\').src=\'' . $path . '\';document.getElementById(\'back-body\').src=\'' . $back_path . '\';document.getElementById(\'body-right\').src=\'' . $right_path . '\';document.getElementById(\'body-left\').src=\'' . $left_path . '\';document.getElementById(\'body-color-picker\').style.background=\'' . $color_code . '\';'
                                        . 'document.getElementById(\'tmp_body_color\').value=\'' . $color_code . '\';document.getElementById(\'tmp_body\').value=\'body.png\';document.getElementById(\'tmp_back_body\').value=\'back.png\';document.getElementById(\'tmp_body_right\').value=\'body-right.png\';document.getElementById(\'tmp_body_left\').value=\'body-left.png\''
                                        . '"></span>';
                            }
                            ?>
                        </div>
                        ...
                        <div class="body-picker" id="snap_types">
                            ...
                            foreach ($snaps as $snap) {
                                echo '<span class="btn round" title="' . $snap->title . '" style="background:' . $snap->color . '" onclick="document.getElementById(\'buttons\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->image . '\'; document.getElementById(\'buttons-right\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->right_image . '\';document.getElementById(\'buttons-left\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->left_image . '\';document.getElementById(\'snap-color-picker\').style.background=\'' . $snap->color . '\';'
                                         . 'document.getElementById(\'tmp_snap_color\').value=\'' . $snap->color . '\';document.getElementById(\'tmp_front_snap\').value=\''.$snap->image . '\';document.getElementById(\'tmp_right_snap\').value=\''.$snap->right_image . '\';document.getElementById(\'tmp_left_snap\').value=\''.$snap->left_image . '\''
                                        . '"></span>';
                            }
                            /* foreach ($products  as $product)
                              {
                        ...
                        <div class="body-picker">
                            ...
                            foreach ($products as $product) {
                                ...
                                echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'pockets\').src=\'' . $path . '\'; document.getElementById(\'pocket-right\').src=\'' . $right_path . '\';document.getElementById(\'pocket-left\').src=\'' . $left_path . '\';document.getElementById(\'pocket-color-picker\').style.background=\'' . $color_code . '\';'
                                         . 'document.getElementById(\'tmp_pocket_color\').value=\'' . $color_code . '\';document.getElementById(\'tmp_front_pocket\').value=\'pockets.png\';document.getElementById(\'tmp_right_pocket\').value=\'pocket-right.png\';document.getElementById(\'tmp_left_pocket\').value=\'pocket-left.png\''
                                        . '"></span>';
                            }
                            ?>
                        </div>
                            ...
                            <div class="body-picker">
                                ...
                                foreach ($products as $product) {
                                    ...
                                    echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'knit\').src=\'' . $path . '\'; document.getElementById(\'back-knit\').src=\'' . $back_path . '\';document.getElementById(\'knit-right\').src=\'' . $right_path . '\'; document.getElementById(\'knit-left\').src=\'' . $left_path . '\';document.getElementById(\'base-color-picker\').style.background=\'' . $color_code . '\';'
                                            . 'document.getElementById(\'tmp_knit_color\').value=\'' . $color_code . '\';document.getElementById(\'tmp_front_knit\').value=\'knit.png\';document.getElementById(\'tmp_back_knit\').value=\'knit-back.png\';document.getElementById(\'tmp_right_knit\').value=\'knit-right.png\';document.getElementById(\'tmp_left_knit\').value=\'knit-left.png\''
                                            . '"></span>';
                                }
                                ?>
                            </div>
