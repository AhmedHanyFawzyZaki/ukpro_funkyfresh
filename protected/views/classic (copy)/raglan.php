                ...
                <div class="color-row">
                    ...
                    <div class="toggle-picker">
                        ...
                        <div class="body-picker" id="snap_types">
                            ...
                            <?php
                            $snaps = Snap::model()->findAll(array('condition' => 'type=0 and sub_category=3'));
                    ...
                    <div class="color-pick knit-picker">
                        <div class="color-row">
                            ...
                            <div class="toggle-picker">
                                ...
                                <div class="body-picker">
                                    <?php
                                    echo StripeBorder::getStripesBorder('3');
                                    ?>
