...
<div class="wrapper">
    ...
    <div class="container margin0px" style="position:relative;">
        <div class="rev-left" id="index">
            ...
            <div class="colors">
                <?php
                echo CHtml::dropDownList('','', CHtml::listData(Size::model()->findAll(),'id','title'),
                array('prompt'=>'Select Size','onchange'=>'$("#form_size").val(this.value)'));
                ?>
            </div>
        ...
        <div class="rev-left" style="display:none;" id="step2">
            ...
            <!--<div class="row1">
                <a href="javascript:void(0)" onclick="change_left('step2', 'step4')" class="btn next" >next</a>
        ...
        <div class="rev-left" id="step3" style="display:none;">
            ...
            <div class="colors">
                <?php
                echo CHtml::dropDownList('','', array('0'=>'Snap'/*,'1'=>'Zip','2'=>'Hidden Zip'*/),
                array('onchange'=>'ChangeSnapType(this.value)'));
                ?>
            </div>
                 ...
                 <div class="color-row">
                    ...
                    <div class="toggle-picker">
                        ...
                        <div class="body-picker" id="snap_types">
                            ...
                            <?php
                $snaps = Snap::model()->findAll(array('condition' => 'type=0 and sub_category=5'));
                foreach ($snaps as $snap) {
                    echo '<span class="btn round" title="' . $snap->title . '" style="background:' . $snap->color . '" onclick=" document.getElementById(\'form_buttons\').value=\'' . $snap->id . '\';document.getElementById(\'buttons\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->image . '\'; document.getElementById(\'buttons-right\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->right_image . '\';document.getElementById(\'buttons-left\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->left_image . '\';"></span>';
                }
                ?>
                        </div>
...
foreach ($products as $product) {
    ...
    echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick=" document.getElementById(\'form_pockets\').value=\'' . $color . '\';document.getElementById(\'pockets\').src=\'' . $path . '\'; document.getElementById(\'pocket-right\').src=\'' . $right_path . '\';document.getElementById(\'pocket-left\').src=\'' . $left_path . '\';"></span>';
}
?>
                        </div>
            ...
            <!--<div class="row1">
                ...
                <a href="javascript:void(0)" onclick="change_left('step4', 'step2')" class="btn bk" >previous</a>
            </div>-->
                    ...
                    <div class="color-pick knit-picker">
                        <div class="color-row">
                            ...
                            <div class="toggle-picker">
                                ...
                                <div class="body-picker">
                                    <?php
                        echo StripeBorder::getStripesBorder('5');
                    ?>
        ...
        <div class="rev-left" id="step7" style="display:none;">
            ...
            <h5 class="title8">choose Your Zip Color :</h5>
            
            <div class="color-pick">
                <div class="color-row">
                    <p>Select color</p>
                    <a class="pick-link picker-click">
                        <img src="<?php echo Yii::app()->getBaseUrl(true); ?>/img/picker-icon.png">
                    </a>
                    <div class="toggle-picker">
                ...
                foreach ($products as $product) {
                    ...
                    echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick=" document.getElementById(\'form_top_zip\').value=\'' . $color . '\';document.getElementById(\'zip_top\').src=\'' . $path . '\'; "></span>';
                }
                ?>
                        </div>
            ...
            <div class="shape-type">
                ...
                <label class="control-label proc" for="inputEmail">Letter Color:</label>
                <div class="colors">
                '.Color::getColorsLinks1().'
                </div>
                <label class="control-label proc" for="inputEmail" style="width:50%;">Outline Color:</label>
                <div class="colors">
                '.Color::getColorsLinksBack1('right_text_id','form_left_chest_text_shadow').'
                </div>
                </div>
                '),
...
<?php echo $this->renderPartial('_Buybuttons', array()); ?>
        ...
        <div>
<?php echo $this->renderPartial('_steps-light-weight', array()); ?>
        </div>
