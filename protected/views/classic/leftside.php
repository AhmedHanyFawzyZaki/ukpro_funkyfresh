...
<div class="wrapper">
    ...
    <div class="container margin0px" style="position:relative;">
        ...
        <div class="rev-left" id="step2" style="display:none;">
            ...
            <div class="colors">
                <?php
                echo CHtml::dropDownList('', '', CHtml::listData(Size::model()->findAll(), 'id', 'title'), array('class'=>'form_size_','prompt' => 'Select Size', 'onchange' => '$("#form_size").val(this.value)'));
                ?>
            </div>
            
            

            <div class="colors colors_">
                <select onchange="">
            ...
            $(document).ready(function(){
                $(".form_size_").val(<?php echo $tmp_product->form_size ?>)
            });
            </script>
            <div class="body-sizes">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" value="<?php echo $tmp_product->chest_size ?>" onkeyup="document.getElementById('tmp_chest_size').value=this.value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" value="<?php echo $tmp_product->waist_size ?>" onkeyup="document.getElementById('tmp_waist_size').value=this.value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" value="<?php echo $tmp_product->shoulder_length ?>" onkeyup="document.getElementById('tmp_shoulder_length').value=this.value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" value="<?php echo $tmp_product->body_length ?>" onkeyup="document.getElementById('tmp_body_length').value=this.value">
                    </div>
                </div>

                <div class="control-group">
                    <label class="control-label" for="chest">sleeve length:</label>
                    <div class="controls">
                        <input type="text"  maxlength="50" value="<?php echo $tmp_product->sleeve_length ?>" onkeyup="document.getElementById('tmp_sleeve_length').value=this.value">
                    </div>
                </div>
            </div>
        ...
        <div class="rev-left" id="step3" style="display:none;">
                    ...
                    <div class="toggle-picker">
                        <div class="body-picker">
                            ...
                            foreach ($products as $product) {
                                ...
                                echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'tmp_body_color\').value=\'' . $product->color_title . '\';document.getElementById(\'body\').src=\'' . $path . '\';document.getElementById(\'back-body\').src=\'' . $back_path . '\';document.getElementById(\'body-right\').src=\'' . $right_path . '\';document.getElementById(\'body-left\').src=\'' . $left_path . '\';'
                                        . 'document.getElementById(\'tmp_body\').value=\'body.png\';document.getElementById(\'tmp_back_body\').value=\'back.png\';document.getElementById(\'tmp_body_right\').value=\'body-right.png\';document.getElementById(\'tmp_body_left\').value=\'body-left.png\';document.getElementById(\'tmp_product_id\').value=\''.$product->id.'\' ;document.getElementById(\'body-color-picker\').style.background=\'' . $color_code . '\';'
                                        . '"></span>';
                            }
            ...
            <script>
            $(document).ready(function(){
             //  document.getElementById("tmp_product_id").value = <?php// echo $product->id ?> ; 
            });
            </script>
                    ...
                    <div class="toggle-picker">
                        <div class="body-picker">
                            ...
                            foreach ($products as $product) {
                                ...
                                echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'sleeves\').src=\'' . $path . '\'; document.getElementById(\'back-sleeves\').src=\'' . $back_path . '\';document.getElementById(\'sleeve-right\').src=\'' . $right_path . '\';document.getElementById(\'sleeve-left\').src=\'' . $left_path . '\';document.getElementById(\'sleeves-color-picker\').style.background=\'' . $color_code . '\';'
                                        . 'document.getElementById(\'tmp_sleeves_color\').value=\'' . $color . '\';document.getElementById(\'tmp_front_sleeves\').value=\'front-sleeves.png\';document.getElementById(\'tmp_back_sleeves\').value=\'back-sleeves.png\';document.getElementById(\'tmp_right_sleeves\').value=\'sleeve-right.png\';document.getElementById(\'tmp_left_sleeves\').value=\'sleeve-left.png\''
                                        . '"></span>';
                            }
                            ?>
                        </div>
                ...
                <div class="color-row">
                    ...
                    <div class="toggle-picker">
                        ...
                        <div class="body-picker" id="snap_types">
                            ...
                            <?php
                            $snaps = Snap::model()->findAll(array('condition' => 'type=0 and sub_category=' . $subcat_id));
                            foreach ($snaps as $snap) {
                                echo '<span class="btn round" title="' . $snap->title . '" style="background:' . $snap->color . '" onclick="document.getElementById(\'buttons\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->image . '\'; document.getElementById(\'buttons-right\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->right_image . '\';document.getElementById(\'buttons-left\').src=\'' . Yii::app()->request->baseUrl . '/media/snap/' . $snap->left_image . '\';document.getElementById(\'snap-color-picker\').style.background=\'' . $snap->color . '\';'
                                         . 'document.getElementById(\'tmp_snap_color\').value=\'' . $snap->title . '\';document.getElementById(\'tmp_front_snap\').value=\''.$snap->image . '\';document.getElementById(\'tmp_right_snap\').value=\''.$snap->right_image . '\';document.getElementById(\'tmp_left_snap\').value=\''.$snap->left_image . '\''
                                        . '"></span>';
                            }
                            /* foreach ($products  as $product)
                              {
...
$zip_path = Yii::app()->getBaseUrl(true) . '/media/types/' . $cat_and_sub_path . '/' . $color . '/top_zip.png';
                                echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'pockets\').src=\'' . $path . '\'; document.getElementById(\'pocket-right\').src=\'' . $right_path . '\';document.getElementById(\'pocket-left\').src=\'' . $left_path . '\';document.getElementById(\'pocket-color-picker\').style.background=\'' . $color_code . '\';'
                                         . 'document.getElementById(\'tmp_pocket_color\').value=\'' . $color . '\';document.getElementById(\'tmp_front_pocket\').value=\'pockets.png\';document.getElementById(\'tmp_right_pocket\').value=\'pocket-right.png\';document.getElementById(\'tmp_left_pocket\').value=\'pocket-left.png\';document.getElementById(\'zip_top\').src=\''.$zip_path.'\';'
                                        . '"></span>';
                            }
                            ?>
                        </div>
        ...
        <div class="rev-left" style="display:none;" id="step7">
            ...
            <div class="colors">
                        ...
                        <div class="toggle-picker">
                            ...
                            <div class="body-picker">
                                ...
                                foreach ($products as $product) {
                                    ...
                                    echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'tmp_knit_color\').value=\'' . $color . '\';'
                                            . 'document.getElementById(\'tmp_front_knit\').value=\'knit.png\';document.getElementById(\'tmp_back_knit\').value=\'knit-back.png\';document.getElementById(\'tmp_right_knit\').value=\'knit-right.png\';document.getElementById(\'tmp_left_knit\').value=\'knit-left.png\';'
                                            . 'document.getElementById(\'knit\').src=\'' . $path . '\'; document.getElementById(\'back-knit\').src=\'' . $back_path . '\';document.getElementById(\'knit-right\').src=\'' . $right_path . '\'; document.getElementById(\'knit-left\').src=\'' . $left_path . '\';document.getElementById(\'base-color-picker\').style.background=\'' . $color_code . '\';"></span>';
                                }
                                ?>
                            </div>
                ...
                <div id="single_stripe_div" <?php if($subcat_id != 6){ ?>style="display:none;"<?php } ?>>
                    <div class="color-pick knit-picker">
                        <div class="color-row">
                            ...
                            <div class="toggle-picker">
                                <div class="body-picker">
                                    <?php
                                    echo Stripe::getStripes('1', $subcat_id);
                                    ?>
                                </div>
                            </div><!--end toggle-picker-->
                        </div>
                    ...
                    <div class="color-pick knit-picker">
                        <div class="color-row">
                            ...
                            <div class="toggle-picker">
                                <div class="body-picker">
                                    <?php
                                    echo Stripe::getStripes('2', $subcat_id);
                                    ?>
                                </div>
                            </div><!--end toggle-picker-->
                        </div>
                ...
                <div id="knit_border_selection" <?php if($subcat_id != 6){ ?>style="display:none;"<?php } ?>>
                    <div class="color-pick knit-picker">
                        <div class="color-row">
                            ...
                            <div class="toggle-picker">
                                <div class="body-picker">
                                    <?php
                                    echo StripeBorder::getStripesBorder($subcat_id);
                                    ?>
                                </div>
                            </div><!--end toggle-picker-->
                        </div>
 ...
 <?php } ?>
        ...
        <div class="rev-left" style="display:none;" id="step8">
            ...
            <div class="shape-type">
                ...
                document.getElementById('tmp_rightchest_image').value=''+fileName+'';
                document.getElementById('left_text_id1').innerHTML='';
                ...
                <option value=\'\'>Select Letter Font</option>
                ...
                <div class="color-pick" style="display:none;" id = "right_two_colors1">
                    <div class="color-row">
                        ...
                        <div class="toggle-picker">
                            <div class="color-picker">
                           ' . Color::getColorsLinksBack1('left_text_id1', 'form_left_chest_text_shadow1','1') . '
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="color-pick" style="display:none;" id = "right_two_colors2">
                    <div class="color-row">
                        ...
                        <div class="toggle-picker">
                            <div class="color-picker">
                            ' . Color::getColorsLinksBack1('left_text_id2', 'form_left_chest_text_shadow2','1') . '
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="rev-left" id="step9" style="display:none;">
            ...
            <div class="shape-type">
               ...
               document.getElementById('tmp_leftchest_image').value=fileName;
document.getElementById('r-1').innerHTML='';
                ...
                if($subcat_id == 5 or $subcat_id ==6){
                    
  echo $content2='   <div class="control-group"  style="display:table;width:100%">
       <div class="color-pick" >
                
                <div class="color-row" id = "zip-color">
                <p>Select color</p>
                <a class="pick-link picker-click" id="zip-color-picker"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                    <div class="color-picker">
                    ' . Color::getTopZipLinks() . '
                    </div>
                </div>
                </div> </div>        </div>       ';
                ...
                <div class="toggle-picker">
                <div class="color-picker">
                 ' . Color::getColorsLinksBack1('right_text_id', 'form_right_chest_text_shadow','2') . '
                </div>
                </div>
...
//                    //'activeTab'=>'tab1',
//                    'tabs' => array(
//                        'Letters1' => array('title' => 'Top Zip', 'content' => '
//                            '.$content.'
//
//                '),
//                       
...
//                }else{
                 ...
                 if($subcat_id != 5 AND $subcat_id !=6){
                     $this->widget('CTabView', array(
                    //'activeTab'=>'tab1',
                    'tabs' => array(
        ...
        <div class="rev-left" id="step10" style="display:none;">
            ...
            <div class="shape-type">
                ...
                document.getElementById('arm_left_txt_id1').value='';
                 document.getElementById('tmp_rightarm_image').value=fileName;
                }
                }",
                    )
                ));
                ...
                document.getElementById('arm_left_txt_id2').value='';
                 document.getElementById('tmp_rightarm_image2').value=fileName;
                }
                }",
                    )
                ));
                ...
                <p>Letter color</p>
                <a class="pick-link picker-click" id="line1leftarm-color-picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
               ' . Color::getColorsLinksLeftSide("1","1") . '
                </div>
                </div>
                ...
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="line1leftarm-color-picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
               ' . Color::getColorsLinksBack1('leftarm_text_id1', 'form_left_arm_text_shadow1' ,'1') . '
                </div>
                </div>
                ...
                <select class="letter-select" onchange="navigate_pickers(this.value, \'right_arm2\')">
                <option value="1">One Color</option>
                <option value="2">Two Colors</option>
               <!-- <option>Three Colors</option>-->
				...
				<div class="color-pick letters-pick" id="right_arm_pick_div1">
                <div class="color-row">
                <p>Letter color</p>
                <a class="pick-link picker-click" id="line2leftarm-color-picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
               ' . Color::getColorsLinksLeftSide("1","2") . '
                </div>
                </div>
				...
				<div class="color-pick letters-pick" id="right_arm_pick_div2" style="display:none">
                <div class="color-row">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="line2leftarm-color-picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
                ' . Color::getColorsLinksBack1('leftarm_text_id2', 'form_left_arm_text_shadow2','2') . '
                </div>
                </div>
        ...
        <div class="rev-left" id="step11" style="display:none;">
            ...
            <div class="shape-type">
               ...
               document.getElementById('tmp_leftarm_image').value=fileName;
              ...
              document.getElementById('tmp_leftarm_image2').value=fileName;
             document.getElementById('arm_right_txt_id2').value='';
                ...
                <select class="letter-select" onchange="navigate_pickers(this.value, \'left_arm1\')" >
                <option value="1">One Color</option>
                <option value="2">Two Colors</option>
               <!-- <option>Three Colors</option>-->
                </select>
		...
		<div class="color-pick letters-pick">
                <div class="color-row">
                <p>Letter color </p>
                <a class="pick-link picker-click" id="line1left_letter_color_picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
               ' . Color::getColorsLinksRightSide("1",'1') . '
                </div>
                </div>
		...
		<div class="color-pick letters-pick">
                <div class="color-row" id="left_letter_color_picker_2" style="display:none;">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="line1right_letter_color_picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
                ' . Color::getColorsLinksBack1('rightarm_text_id1', 'form_right_arm_text_shadow1','1') . '
                </div>
                </div>
		...
		<label class="control-label proc" for="inputEmail">Letter Color(s):</label>
                ...
                <select class="letter-select" onchange="navigate_pickers(this.value, \'left_arm2\')">
                <option value="1">One Color</option>
                <option value="2">Two Colors</option>
                <!--<option>Three Colors</option>-->
                </select>
		...
		<div class="color-pick letters-pick" id="left_arm_pick_div1">
                <div class="color-row">
                <p>Letter color</p>
                <a class="pick-link picker-click" id="line2left_letter_color_picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
                ' . Color::getColorsLinksRightSide("1",'2') . '
                </div>
                </div>
		...
		<div class="color-pick letters-pick" id="left_arm_pick_div2"  style="display:none">
                <div class="color-row">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="line2right_letter_color_picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
                ' . Color::getColorsLinksBack1('rightarm_text_id2', 'form_right_arm_text_shadow2','2') . '
                </div>
                </div>
        ...
        <div class="rev-left" id="step12" style="display:none;">
            ...
            <div class="shape-type">
                ...
                document.getElementById('tmp_back_image').value=fileName;
                ...
                <select class="letter-select"  onchange="navigate_pickers(this.value, \'back_top_line\')">
                <option vlaue="1">One Color</option>
                <option value="2">Two Colors</option>
				...
				<div class="color-pick letters-pick" id="back_top_line_div1">
                <div class="color-row">
                <p>Letter color</p>
                <a class="pick-link picker-click" id="top-line-color-picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
              ' . Color::getColorsLinksBack("back_text_id", "tmp_back_text_color","top-line-color-picker1") . '
                </div>
                </div>
				...
				<div class="color-pick letters-pick" id="back_top_line_div2" style="display:none">
                <div class="color-row">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="back-color-picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>
               ...
               ' . Color::getColorsLinksBack1('back_text_id', 'form_back_text_shadow','') . '
                ...
                <select class="letter-select" onchange="navigate_pickers(this.value, \'back_middle_line\')">
                <option value="1">One Color</option>
                <option value="2">Two Colors</option>
		...
		<div class="color-pick letters-pick" id="back_middle_line_div1">
                <div class="color-row">
                <p>Letter color</p>
                <a class="pick-link picker-click" id="middle-line-color-picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
               ' . Color::getColorsLinksBack("back_text_id1", "tmp_back_text_color1","middle-line-color-picker1") . '
                </div>
                </div>
		...
		<div class="color-pick letters-pick" id="back_middle_line_div2" style="display:none">
                <div class="color-row">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="back1-color-picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
               ' . Color::getColorsLinksBack1('back_text_id', 'form_back_text_shadow1','1') . '
                </div>
                </div>
                ...
                <select class="letter-select" onchange="navigate_pickers(this.value, \'back_bottom_line\')">
                <option value="1">One Color</option>
                <option value="2">Two Colors</option>
				...
				<div class="color-pick letters-pick" id="back_bottom_line_div1">
                <div class="color-row">
                <p>Letter color</p>
                <a class="pick-link picker-click" id="bottom-line-color-picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
               ' . Color::getColorsLinksBack("back_text_id2", "tmp_back_text_color2","bottom-line-color-picker1") . '
                </div>
                </div>
	   ...
	   <div class="color-pick letters-pick" id="back_bottom_line_div2" style="display:none">
                <div class="color-row">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="back2-color-picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
                ' . Color::getColorsLinksBack1('back_text_id', 'form_back_text_shadow2','2') . '
                </div>
                </div>
                ...
                <select class="letter-select" onchange="navigate_pickers(this.value, \'back_tail_line\')">
                <option value="1">One Color</option>
                <option value="2">Two Colors</option>
				...
				<div class="color-pick" id="back_tail_line_div1">
                <div class="color-row">
                <p>Letter color</p>
                <a class="pick-link picker-click" id="tail-color-picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
                
               ' . Color::getColorsLinksBack('back_text_id', 'tmp_back_text_color','tail-color-picker1') . '
				...
				<div class="color-pick" id="back_tail_line_div2" style="display:none">
                <div class="color-row">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="back4-color-picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
              ' . Color::getColorsLinksBack1('back_text_id', 'tmp_back_text_color2','') . ' 
                </div>
                </div>
                ...
                <a class="pick-link picker-click" id="tail-color-picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>

                <div class="toggle-picker">
                <div class="color-picker">
              ' . Color::getColorsLinksBack('sub_tail', 'tmp_back_text_color2','tail-color-picker2') . '
                </div>
                </div>
            ...
            <!--<div class="row1">
                ...
                <a href="javascript:void(0)" onclick="change_left('step10', 'body.pngstep11')" class="btn next" >next</a>
...
<script>
    function change_stripe_border(value)
    {
        ...
        document.getElementById('left-knit_stripe_border').innerHTML = '<img src="<?= Yii::app()->getBaseUrl(true) ?>/media/stripeborder/left/' + value + '">';
         document.getElementById('tmp_double_stripe').value = value;
         document.getElementById('tmp_double_stripe_back').value = value;
         document.getElementById('tmp_knit_double_stripe_right').value = value;
         document.getElementById('tmp_knit_double_stripe_left').value = value;
        if (value != '')
        {
...
<script>
    function change_txt(value, flag)
    {
        ...
        document.getElementById('tmp_rightchest'+ flag).value = value;
...
<script>
    ...
    {
         document.getElementById('tmp_rightchest_txt_type'+flag).value= family;
...
<script>
    ...
    // alert(value);   
        ...
        document.getElementById('tmp_leftchest').value = value;
        if (value[0])
        {
...
<script>
    ...
    { 
        document.getElementById('tmp_leftchest_txt_type').value= value;
...
<script>
    ...
    { 
        document.getElementById('tmp_leftchest_txt_color').value= value;
...
<script>
    function navigate_pickers(option, type) {
        if (type == 'right_chest1') {
         ...
         else if (type == 'right_arm2') {

            if (option == 2) {
                $('#right_arm_pick_div1').css('display', 'block');
                $('#right_arm_pick_div2').css('display', 'block');
            }
            else if (option == 1) {
                $('#right_arm_pick_div1').css('display', 'block');
                $('#right_arm_pick_div2').css('display', 'none');
            }
        }
        else if (type == 'left_arm1') {

            if (option == 1) { 
                $('#left_letter_color_picker1').css('display', 'block');
                $('#left_letter_color_picker_2').css('display', 'none');
            }
            else if (option == 2) {
                $('#left_letter_color_picker_2').css('display', 'block');
            }
        }
        else if (type == 'left_arm2') {

            if (option ==1) {
                $('#left_arm_pick_div1').css('display', 'block');
                $('#left_arm_pick_div2').css('display', 'none');
            }
            else if (option == 2) {
                $('#left_arm_pick_div1').css('display', 'block');
                $('#left_arm_pick_div2').css('display', 'block');
            }
        }
        
         else if (type == 'back_top_line') {

            if (option == 1) {
                $('#back_top_line_div1').css('display', 'block');
                $('#back_top_line_div2').css('display', 'none');
            }
            else if (option == 2) {
                $('#back_top_line_div1').css('display', 'block');
                 $('#back_top_line_div2').css('display', 'block');
            }
        }
        
        else if (type == 'back_middle_line') {

            if (option == 1) {
                $('#back_middle_line_div1').css('display', 'block');
                $('#back_middle_line_div2').css('display', 'none');
            }
            else if (option == 2) {
                $('#back_middle_line_div1').css('display', 'block');
                 $('#back_middle_line_div2').css('display', 'block');
            }
        }
        else if (type == 'back_bottom_line') {

            if (option == 1) {
                $('#back_bottom_line_div1').css('display', 'block');
                $('#back_bottom_line_div2').css('display', 'none');
            }
            else if (option == 2) {
                $('#back_bottom_line_div1').css('display', 'block');
                 $('#back_bottom_line_div2').css('display', 'block');
            }
        }
        
        else if (type == 'back_tail_line') {

            if (option == 1) {
                $('#back_tail_line_div1').css('display', 'block');
                $('#back_tail_line_div2').css('display', 'none');
            }
            else if (option == 2) {
                $('#back_tail_line_div1').css('display', 'block');
                 $('#back_tail_line_div2').css('display', 'block');
            }
        }
...
<script>
    ...
    {
        document.getElementById('tmp_rightarm' + flag).value = value;
...
//        document.getElementById('form_left_arm_image' + flag).value = '';
        ...
        var line2 = document.getElementById('tmp_rightarm1').value;
...
<script>
    ...
    {
        document.getElementById('tmp_rightarm_txt_type' + flag).value = value;
...
<script>
    function change_txt_color_leftside(value, flag ,line)
    { 
        console.log( flag);
        document.getElementById('tmp_rightarm_txt_color' + line).value = value;
        document.getElementById('leftarm_text_id' + line).style.color = value;
       
        document.getElementById('line'+line+'leftarm-color-picker' + flag).style.background = value;
...
<script>
    ...
    {
         document.getElementById('tmp_leftarm' + flag).value = value;
         
        document.getElementById('rightarm_text_id' + flag).innerHTML = value;
        document.getElementById('rightarm-color-picker' + flag).value = value;
...
<script>
    ...
    {
         document.getElementById('tmp_leftarm_txt_type' + flag).value = value;
...
<script>
    function change_txt_color_rightside(value, flag ,line)
    {
        document.getElementById('tmp_leftarm_txt_color' + line).value = value;
       // console.log('rightarm-color-picker' + flag);
        document.getElementById('rightarm_text_id' + line).style.color = value;
        document.getElementById('line'+line+'left_letter_color_picker' + flag).style.background = value;
...
<script>
    function change_txt_back(value, type, flag)
    {
        ...
        if (type != 'tail')
        {
            document.getElementById('tmp_back_type').value = '';
           
            value = value.toUpperCase();
            document.getElementById('back_text_id' + flag).innerHTML = value;

            if (document.getElementById('tmp_back_text_type').value != "letters")
            {
        ...
        {
            document.getElementById('tmp_back_type').value = type;
        ...
        //    document.getElementById('form_back_text_shadow2').value = '';
         ...
         //   document.getElementById('form_back_text_type').value = "tail";
            ...
            if (value[2])
            {
                ...
                document.getElementById('sub_tail').style.bottom = '-4px';
        ...
        change_sub_tail(document.getElementById('subtail_id').value);
         document.getElementById('tmp_back_text' + flag).value = value;
    }
</script>
<script>
    function change_txt_family_back(value, flag)
    {
        /*if(value=="vintage")
         ...
         document.getElementById('tmp_back_text_type' + flag).value = value;
...
<script>
    function change_txt_color_back(value, id, form_id ,picker_id)
    {
//console.log(form_id);
       //   document.getElementById('tmp_back_text_color' + flag).value = value;
        document.getElementById(id).style.color = value;
        document.getElementById(form_id).value = value;
        document.getElementById(picker_id).style.background = value;

    }
</script>
<script>
    function change_txt_color_back1(value, text_id, form_id ,line)
    {
        
     //   document.getElementById(text_id+line).style.textShadow = '-1px -1px 0 ' + value + ', 1px -1px 0 ' + value + ', -1px 1px 0 ' + value + ', 1px 1px 0 ' + value + '';
        if (text_id == 'rightarm_text_id'+line) {
            document.getElementById('line'+line+'right_letter_color_picker2').style.background = value;
            document.getElementById(text_id).style.textShadow = '-1px -1px 0 ' + value + ', 1px -1px 0 ' + value + ', -1px 1px 0 ' + value + ', 1px 1px 0 ' + value + '';
        } else if (text_id == 'leftarm_text_id'+line) {
            document.getElementById('line'+line+'leftarm-color-picker2').style.background = value;
        document.getElementById(text_id).style.textShadow = '-1px -1px 0 ' + value + ', 1px -1px 0 ' + value + ', -1px 1px 0 ' + value + ', 1px 1px 0 ' + value + '';
        }else if(text_id == "back_text_id"){
             document.getElementById('back'+line+'-color-picker2').style.background = value;
             document.getElementById(text_id+line).style.textShadow = '-1px -1px 0 ' + value + ', 1px -1px 0 ' + value + ', -1px 1px 0 ' + value + ', 1px 1px 0 ' + value + '';
        }else if(text_id == "right_text_id"){
             document.getElementById('right_letter_color_picker2').style.background = value;
             document.getElementById(text_id).style.textShadow = '-1px -1px 0 ' + value + ', 1px -1px 0 ' + value + ', -1px 1px 0 ' + value + ', 1px 1px 0 ' + value + '';
        } if(form_id == "tmp_back_text_color2"){
            console.log('ds');
            document.getElementById('back4-color-picker2').style.background = value;
             document.getElementById(text_id+line).style.textShadow = '-1px -1px 0 ' + value + ', 1px -1px 0 ' + value + ', -1px 1px 0 ' + value + ', 1px 1px 0 ' + value + '';
        }
...
<script>
    ...
    {
       // alert(value);
//        if (document.getElementById('tmp_back_text2').value != "letters" && document.getElementById('form_back_text').value != '')
//        {
            document.getElementById('sub_tail').innerHTML = value;
            document.getElementById('tmp_back_text2').value= value;
