...
<div class="wrapper">
    ...
    <div class="container margin0px" style="position:relative;">
        ...
        <div class="rev-left" id="step5" style="display:none;">
            ...
            <div class="colors">
                <?php
                echo CHtml::dropDownList('', '', array('0' => 'Snap'/* ,'1'=>'Zip','2'=>'Hidden Zip' */), array('onchange' => 'ChangeSnapType(this.value)'));
                ?>
            </div>
            ...
            <div class="color-pick" id="snap_types">
                <div class="color-row">
                    <p>Select color</p>
                    ...
                    <div class="toggle-picker">
                        <div class="body-picker">
                            <?php
                            $snaps = Snap::model()->findAll(array('condition' => 'type=0 and sub_category=2'));
                    ...
                    <div class="color-pick knit-picker">
                        <div class="color-row">
                            ...
                            <div class="toggle-picker">
                                ...
                                <div class="body-picker">
                                    <?php
                                    echo StripeBorder::getStripesBorder('2');
                                    ?>
        ...
        <div class="rev-left" id="step12" style="display:none;">
            ...
            <div class="shape-type">
                ...
                <label class="control-label proc" for="inputEmail">Tail inner text:</label>
