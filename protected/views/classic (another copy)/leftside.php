...
<div class="wrapper">
    ...
    <div class="container margin0px" style="position:relative;">
        ...
        <div class="rev-left" id="step2" style="display:none;">
            ...
            <div class="body-sizes">
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" onkeyup="document.getElementById('tmp_chest_size').value=this.value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" onkeyup="document.getElementById('tmp_waist_size').value=this.value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" onkeyup="document.getElementById('tmp_shoulder_length').value=this.value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" onkeyup="document.getElementById('tmp_body_length').value=this.value">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text"  maxlength="50" onkeyup="document.getElementById('tmp_sleeve_length').value=this.value">
                    </div>
                </div>
            </div>
                    ...
                    <div class="toggle-picker">
                        <div class="body-picker">
                            ...
                            foreach ($products as $product) {
                                ...
                                echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'body\').src=\'' . $path . '\';document.getElementById(\'back-body\').src=\'' . $back_path . '\';document.getElementById(\'body-right\').src=\'' . $right_path . '\';document.getElementById(\'body-left\').src=\'' . $left_path . '\';document.getElementById(\'body-color-picker\').style.background=\'' . $color_code . '\';'
                                        . 'document.getElementById(\'tmp_body_color\').value=\'' . $product->color_title . '\';document.getElementById(\'tmp_body\').value=\'body.png\';document.getElementById(\'tmp_back_body\').value=\'back.png\';document.getElementById(\'tmp_body_right\').value=\'body-right.png\';document.getElementById(\'tmp_body_left\').value=\'body-left.png\';document.getElementById(\'tmp_product_id\').value=\''.$product->id.'\''
                                        . '"></span>';
                            }
                            ?>
                        </div>
                        ...
                        <div class="body-picker">
                            ...
                            foreach ($products as $product) {
                                ...
                                echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'pockets\').src=\'' . $path . '\'; document.getElementById(\'pocket-right\').src=\'' . $right_path . '\';document.getElementById(\'pocket-left\').src=\'' . $left_path . '\';document.getElementById(\'pocket-color-picker\').style.background=\'' . $color_code . '\';'
                                         . 'document.getElementById(\'tmp_pocket_color\').value=\'' . $color . '\';document.getElementById(\'tmp_front_pocket\').value=\'pockets.png\';document.getElementById(\'tmp_right_pocket\').value=\'pocket-right.png\';document.getElementById(\'tmp_left_pocket\').value=\'pocket-left.png\''
                                        . '"></span>';
                            }
                            ?>
                        </div>
                            ...
                            <div class="body-picker">
                                ...
                                foreach ($products as $product) {
                                    ...
                                    echo '<span class="btn round" title="' . $product->color_title . '" style="background:' . $color_code . '" onclick="document.getElementById(\'knit\').src=\'' . $path . '\'; document.getElementById(\'back-knit\').src=\'' . $back_path . '\';document.getElementById(\'knit-right\').src=\'' . $right_path . '\'; document.getElementById(\'knit-left\').src=\'' . $left_path . '\';document.getElementById(\'base-color-picker\').style.background=\'' . $color_code . '\';'
                                            . 'document.getElementById(\'tmp_knit_color\').value=\'' . $color . '\';document.getElementById(\'tmp_front_knit\').value=\'knit.png\';document.getElementById(\'tmp_back_knit\').value=\'knit-back.png\';document.getElementById(\'tmp_right_knit\').value=\'knit-right.png\';document.getElementById(\'tmp_left_knit\').value=\'knit-left.png\''
                                            . '"></span>';
                                }
                                ?>
                            </div>
            ...
            <div class="shape-type">
                ...
                $this->widget('ext.EAjaxUpload.EAjaxUpload', array(
                    ...
                    'config' => array(
                        ...
                        'sizeLimit' => 1000 * 1024 * 1024*1024, // maximum file size in bytes
		...
		<div class="color-pick letters-pick">
                <div class="color-row">
                <p>Letter color </p>
                <a class="pick-link picker-click" id="rightarm-color-picker1"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>
		...
		<div class="color-pick letters-pick">
                <div class="color-row">
                <p>Top felt colour</p>
                <a class="pick-link picker-click" id="left_letter_color_picker2"><img src="' . Yii::app()->getBaseUrl(true) . '/img/picker-icon.png"/></a>
...
<script>
    ...
    {
        document.getElementById('tmp_rightarm_txt_color' + flag).value = value;
...
<script>
    ...
    {
        document.getElementById('tmp_leftarm_txt_color' + flag).value = value;
        console.log('rightarm-color-picker' + flag);
        document.getElementById('rightarm_text_id' + flag).style.color = value;
        document.getElementById('rightarm-color-picker' + flag).style.background = value;
