    ...
    <div class="container margin0px" style="position:relative;">
        ...
        <div class="rev-left" style="display:none;" id="step6">
            ...
            <div class="shape-type">
                ...
                document.getElementById('form_left_chest_image').value='".Yii::app()->getBaseUrl(true)."/upload/'+fileName+'?nocache='+Math.random();											                                
               ...
               '.Color::getColorsLinks("1").'
                ...
                <div class="color-row">
                <p>Outline color</p>
                <a class="pick-link picker-click" id="outline_color_picker1"><img src="'.Yii::app()->getBaseUrl(true).'/img/picker-icon.png"/></a>
        ...
        <div class="rev-left" id="step10" style="display:none;">
            ...
            <div class="shape-type">
                ...
                <label class="control-label proc" for="inputEmail">Inner Color:</label>
                <div class="colors">
                ...
                <label class="control-label proc" for="inputEmail">Tail inner text color:</label>
                <div class="colors">
