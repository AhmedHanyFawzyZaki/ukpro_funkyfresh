...
<div class="wrapper">
    ...
    <div class="container margin0px" style="position:relative;">
        ...
        <div class="rev-left" style="display:none;" id="step2">
            <h4>Shoulder Insert color</h4>
            <h5 class="title8">choose your Shoulder color</h5>
                ...
                <div class="color-row">
                    ...
                    <div class="toggle-picker">
                        ...
                        <div class="body-picker" id="snap_types">
                            ...
                            <?php
                $snaps = Snap::model()->findAll(array('condition' => 'type=0 and sub_category=4'));
                ...
                <div class="color-pick knit-picker">
                        <div class="color-row">
                            ...
                            <div class="toggle-picker">
                                ...
                                <div class="body-picker">
                                    <?php
                        echo StripeBorder::getStripesBorder('4');
                    ?>
...
<?php echo $this->renderPartial('_Buybuttons', array()); ?>
        ...
        <div>
<?php echo $this->renderPartial('_steps-retro', array()); ?>
        </div>
